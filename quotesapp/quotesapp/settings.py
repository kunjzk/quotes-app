...
# WhiteNoise serves collected files from gunicorn with hashed names, compression
# and far-future cache headers. The Docker image runs collectstatic at build time.
STORAGES = {
    'default': {'BACKEND': 'django.core.files.storage.FileSystemStorage'},
    'staticfiles': {'BACKEND': 'whitenoise.storage.CompressedManifestStaticFilesStorage'},
}
if 'test' in sys.argv:
    # The manifest only exists after collectstatic; tests shouldn't depend on it.
...
CELERY_BROKER_URL = os.getenv('CELERY_BROKER_URL', 'redis://quotes-redis:6379')
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@quotesapp.local')